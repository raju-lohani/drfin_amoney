...
public class AllCityAdapters extends RecyclerView.Adapter<AllCityAdapters.ViewHolder> {
    private List<CityListModel> cityListModels;
    private Context context;
    private SelectCityStateInterface selectCityStateInterface;
    private int extraFlag;

    public AllCityAdapters(Context context, List<CityListModel> stateListModels, SelectCityStateInterface selectCityStateInterface, int extraFlag) {
